...
export const colorSettings = {
  ...
  propertyMultiSelect: {
    backgroundColor: '#ddd6fe',
    textColor: '#5b21b6',
    className: '.notion-property-multi_select'
  },
  ...
  propertyStatus: {
    ...
    textColor: '#065f46',
    className: '.notion-property-status'
  },
  ...
  propertyTag: {
    backgroundColor: '#f3f4f6',
    textColor: '#374151',
    className: '.notion-property-select-item, .notion-property-multi_select-item'
  }
};
...
export const colorPresets = {
  ...
  dark: {
    ...
    settings: {
      ...
      propertySelect: { backgroundColor: '#422006', textColor: '#fbbf24', className: '.notion-property-select' },
      propertyMultiSelect: { backgroundColor: '#4c1d95', textColor: '#c4b5fd', className: '.notion-property-multi_select' },
      propertyStatus: { backgroundColor: '#064e3b', textColor: '#6ee7b7', className: '.notion-property-status' },
      propertyTag: { backgroundColor: '#1e293b', textColor: '#cbd5e1', className: '.notion-property-select-item, .notion-property-multi_select-item' }
    }
  },
  sepia: {
    name: 'セピア',
    ...
    settings: {
      ...
      propertySelect: { backgroundColor: '#fff4e6', textColor: '#8b5a00', className: '.notion-property-select' },
      propertyMultiSelect: { backgroundColor: '#ffd4a3', textColor: '#7c4700', className: '.notion-property-multi_select' },
      propertyStatus: { backgroundColor: '#f0e6d2', textColor: '#6b5d54', className: '.notion-property-status' },
      propertyTag: { backgroundColor: '#f8f0dc', textColor: '#5c4b3a', className: '.notion-property-select-item, .notion-property-multi_select-item' }
    }
  }
};