...
export const staticSearchIndex: SearchIndexItem[] = [
  {
    ...
    title: 'ホームページ',
    content: 'キネシオロジー カフェ アロマ 講座 効果 歴史 動画 特長',
    searchableText: 'ホームページ キネシオロジー カフェ アロマ 講座 効果 歴史 動画 特長',
    url: '/1ceb802cb0c680f29369dba86095fb38',
    excerpt: 'キネシオロジーやアロマセラピーに関する情報を提供しています',
